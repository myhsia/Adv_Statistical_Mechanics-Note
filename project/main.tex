...
\usepackage{graphicx, float, subcaption, array, booktabs, enumitem, enumext,
            fixdif, derivative, physics2, lmodern, hvlogos, CJKutf8}
...
\emph{Stochastic Series Expansion (SSE)} and \emph{Directed Loop Algorithm} are
